...
class DiffTest extends TestCase
{
    ...
    public function testAssoc()
    {
        ...
        $actual = Workflow::new($array1)->map($this->tasks->diffAssoc($array2))->get();
    ...
    {
        $array2 = ["a" => "green", "yellow", "red"];
        $actual = Workflow::new(1)->map($this->tasks->diffAssoc($array2))->isError();
    ...
    public function testKey()
    {
        ...
        $actual = Workflow::new($array1)->map($this->tasks->diffKey($array2))->get();
        $this->assertSame($expected, $actual);
    }
    ...
    {
        $array2 = ['green' => 5, 'yellow' => 7, 'cyan' => 8];
        $actual = Workflow::new(1)->map($this->tasks->diffKey($array2))->isError();
        $this->assertTrue($actual);
    }
    ...
    public function testUassoc()
    {
        ...
        $actual = Workflow::new($array1)->map($this->tasks->diffUassoc($keyCompare, $array2))->get();
        $this->assertSame($expected, $actual);
    }
    ...
    public function testUassoc_notArray()
    {
        ...
        $actual = Workflow::new(1)->map($this->tasks->diffUassoc($keyCompare, $array2))->isError();
        $this->assertTrue($actual);
    }
    ...
    public function testUkey()
    {
        ...
        $actual = Workflow::new($array1)->map($this->tasks->diffUkey($keyCompare, $array2))->get();
        $this->assertSame($expected, $actual);
    }
    ...
    public function testUkey_notArray()
    {
        ...
        $actual = Workflow::new(1)->map($this->tasks->diffUkey($keyCompare, $array2))->isError();
        $this->assertTrue($actual);
    }
    ...
    public function testDiff()
    {
        ...
        $actual = Workflow::new($array1)->map($this->tasks->diff($array2))->get();
        $this->assertSame($expected, $actual);
    }
    ...
    {
        $array2 = ["b" => "green", "yellow", "red"];
        $actual = Workflow::new(1)->map($this->tasks->diff($array2))->isError();
        $this->assertTrue($actual);
    }
}