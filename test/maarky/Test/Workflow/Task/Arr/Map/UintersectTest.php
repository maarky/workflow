...
class UintersectTest extends TestCase
{
    public function testAssoc()
    {
        ...
        $actual = Workflow::create($array1)->map(Map\array_uintersect_assoc($callback, $array2))->get();
    ...
    public function testAssoc_notArray()
    {
        $array2 = ["a" => "GREEN", "B" => "brown", "yellow", "red"];
        $callback = 'strcasecmp';
        $actual = Workflow::create(1)->map(Map\array_uintersect_assoc($callback, $array2))->isError();
    ...
    public function testUassoc()
    {
        ...
        $actual = Workflow::create($array1)->map(Map\array_uintersect_uassoc($valCompare, $keyCompare, $array2))->get();
        $this->assertSame($expected, $actual);
    }
    ...
    public function testUassoc_notArray()
    {
        ...
        $valCompare = 'strcasecmp';
        $keyCompare = 'strcasecmp';
        $actual = Workflow::create(1)->map(Map\array_uintersect_uassoc($valCompare, $keyCompare, $array2))->isError();
        $this->assertTrue($actual);
    }
    ...
    public function testUintersect()
    {
        ...
        $actual = Workflow::create($array1)->map(Map\array_uintersect($compare, $array2))->get();
        $this->assertSame($expected, $actual);
    }
    ...
    public function testUintersect_notArray()
    {
        $array2 = ["a" => "GREEN", "B" => "brown", "yellow", "red"];
        $compare = 'strcasecmp';
        $actual = Workflow::create(1)->map(Map\array_uintersect($compare, $array2))->isError();
        $this->assertTrue($actual);
    }
}
