...
class IntersectTest extends TestCase
{
    ...
    public function testAssoc()
    {
        ...
        $actual = Workflow::create($array1)->map(Map\array_intersect_assoc($array2))->get();
    ...
    {
        $array2 = ["a" => "green", "b" => "yellow", "blue", "red"];
        $actual = Workflow::create(1)->map(Map\array_intersect_assoc($array2))->isError();
    ...
    public function testKey()
    {
        ...
        $actual = Workflow::create($array1)->map(Map\array_intersect_key($array2))->get();
        $this->assertSame($expected, $actual);
    }
    ...
    {
        $array2 = ['green' => 5, 'blue' => 6, 'yellow' => 7, 'cyan'   => 8];
        $actual = Workflow::create(1)->map(Map\array_intersect_key($array2))->isError();
        $this->assertTrue($actual);
    }
    ...
    public function testUassoc()
    {
        ...
        $actual = Workflow::create($array1)->map(Map\array_intersect_uassoc($keyCompare, $array2))->get();
        $this->assertSame($expected, $actual);
    }
    ...
    public function testUassoc_notArray()
    {
        ...
        $actual = Workflow::create(1)->map(Map\array_intersect_uassoc($keyCompare, $array2))->isError();
        $this->assertTrue($actual);
    }
    ...
    public function testUkey()
    {
        ...
        $actual = Workflow::create($array1)->map(Map\array_intersect_ukey($keyCompare, $array2))->get();
        $this->assertSame($expected, $actual);
    }
    ...
    public function testUkey_notArray()
    {
        ...
        $actual = Workflow::create(1)->map(Map\array_intersect_ukey($keyCompare, $array2))->isError();
        $this->assertTrue($actual);
    }
    ...
    public function testIntersect()
    {
        ...
        $actual = Workflow::create($array1)->map(Map\array_intersect($array2))->get();
        $this->assertSame($expected, $actual);
    }
    ...
    {
        $array2 = ["b" => "green", "yellow", "red"];
        $actual = Workflow::create(1)->map(Map\array_intersect($array2))->isError();
        $this->assertTrue($actual);
    }
}