...
class UtilityTest extends TestCase
{
    public function testBind()
    {
        ...
        $actual = Workflow::create($array)->map(Utility::bind('array_chunk', [$size, $preserveKeys]))->get();
    ...
    public function testBindFlatmap()
    {
        ...
        $actual = Workflow::create($array)->flatMap(Utility::bindFlatmap($class,'implode', [$glue]));
